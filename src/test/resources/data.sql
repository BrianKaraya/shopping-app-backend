-- Passwords must be atleast six characters long beginning with a special character and Capital letter(@Password1)
-- Encrypted using https://www.javainuse.com/onlineBcrypt

insert into local_user(email,password,firstname,lastname,username,role)
values ('t1@shopping.nl','$2a$10$YbGG1SJ5ZOmWTzVc9k.StOoETziQuTl5upLXYjml45wIK.c/Cyr9i','Peter','Pan', 'Ppan','USER'),
       ('t2@shopping.nl','$2a$10$KFKapfLO1MuIH8Q/Im2Q0eUxzXnj.HVgyv41ELIVE79VToh9VAKL.','Peter','Pan', 'Ppan','USER'),
       ('t3@shopping.nl','$2a$10$b0LKmhbJzUCsHfaxOrXviuPKQIu8yzG0mBg6Tu8trs61gzkiKD666','Peter','Pan', 'Ppan','USER');
...
DELETE FROM web_orders where id >= 1;
